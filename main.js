        ...
        projectsInCategory.forEach(project => {
          ...
          card.innerHTML = `
            ...
            <div class="card-content">
              <div class="card-title" onclick="window.open('${project.url}', '_blank')">${project.title}</div>
              <div class="card-description">${project.description}</div>
              <div class="card-footer">
                <div class="card-tags">
                  ${project.tags.map(tag => `<span class="tag" onclick="showTag(${tag})">${tag}</span>`).join('')}
                </div>
                <button class="source-button" onclick="window.open('${project.source}', '_blank')">
